...
var IntegrationMappings = map[string]Integration{
	...
	SFTP:    {DataSource: SFTP, Url: "http://edtsclr1-1-prod-dca.agkn.net:8080/sftp/task/runnow/%s?force=true"},
	...
	TDD_V4:  {DataSource: TDD_V4, Url: "http://edtsclr1-1-prod-dca.agkn.net:8080/tradedesk/task/runnow/%s?force=true"},
	...
	SITE_S3:  {DataSource: SITE_S3, Url: "http://edtsitesclr1-1-prod-dca.agkn.net:8080/s3/task/runnow/%s?force=true"},
	SITE_SFTP:  {DataSource: SITE_SFTP, Url: "http://edtsitesclr1-1-prod-dca.agkn.net:8080/sftp/task/runnow/%s?force=true"},
}
